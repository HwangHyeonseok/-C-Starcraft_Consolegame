...
#iterator 이용하기
				...
				<구현 목표>
2022-08-12 버전에서는 아군과 적 유닛들을 생성하고 싸울 때 적 유닛 1개와 아군 유닛 1개를 골라 전투를 한다.
2022-08-15 버전에서는 아군과 적 유닛들을 이전 버전과 똑같이 생성하고 적 유닛의 HP,ATK 합과 아군 유닛의 HP,ATK의 합을 구해서 전투를 한다.

그로 인해 2022-08-12 버전보다 2022-08-15 버전에서 코드가 많이 빠지게 되었다.

list STL으로는 연산자 오버로딩을 통해서 더할 방법이 떠오르지 않아 iterator 반복자 변수를 통해 하나씩 유닛의 공격력과 체력을 더해서 유닛 전체의 전투를 할 수 있도록 구현하였다.
vector STL에서는 연산자 오버로딩이 된다고 한다.
이 소스파일에서는 list STL으로 반복자 변수를 통해 객체의 공격력과 체력을 더해서 구현하였다.
